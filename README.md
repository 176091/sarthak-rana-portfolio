...
🔗 [View Portfolio Live](https://sarthakrana.vercel.app/)
...
```bash
git clone [https://github.com/sarthakrana/portfolio.git]
cd your-repo-name
```
...
This project was created with ❤️ by [Sarthak Rana](https://sarthakrana.vercel.app/).
